	...
	private static ArrayList<Student> ReadFile (String filepath) {
		...
		try {
			...
			while (scanner.hasNext()) {
				...
				mMath=scanner.next();
				mAvg=scanner.next();
				Integer intId = Integer.parseInt(mId);
				Integer intChi = Integer.parseInt(mChi);
				Integer intEng = Integer.parseInt(mEng);
				Integer intMath = Integer.parseInt(mMath);
				Integer intAvg = Integer.parseInt(mAvg);
				a.setId(intId);
				a.setName(mName);
				a.setChi(intChi);
				a.setEng(intEng);
